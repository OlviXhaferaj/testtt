...
<div class="container">
    ...
    <div class="container mt-2">
        ...
        @endif
        <form action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data" class="pb-3">
            @csrf
            @method('PUT')
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 w-100">
                                        <select id="gender" type="text" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender', $user->gender) }}" required autocomplete="gender">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 w-100">
                                        <p><input type="text" id="datepicker" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth', $user->date_of_birth) }}"  autocomplete="date_of_birth"></p>
                            ...
                            <div class="d-flex flex-column">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 ">
                                        <input id="nikName" type="text" class=" form-control @error('nikName') is-invalid @enderror w-100" name="nikName" value="{{ old('nikName', $user->nikName) }}" autocomplete="nikName">
                                        @error('nikName')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
